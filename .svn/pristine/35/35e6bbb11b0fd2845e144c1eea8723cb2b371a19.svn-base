...
public class DateUtils {
	...
	public static long getCurrOrNextMinuteTime(int nextMinute) {
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.MINUTE, nextMinute);
		return Long.parseLong(formatDateTime.format(calendar.getTime()));
	}	
	
	public static long getCurrOrNextSecondTime(int nextSecond) {
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.SECOND, nextSecond);
		return Long.parseLong(formatDateTime.format(calendar.getTime()));
	}	
	
	public static Long getCurrDateTimeToLong() {
		return Long.valueOf(getCurrDateTime());
	}
