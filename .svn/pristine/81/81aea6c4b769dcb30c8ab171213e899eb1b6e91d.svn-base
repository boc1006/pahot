...
public class RoleTest {
    ...
    public void handleRoleState() {
    	...
    	param.put(DTO.SESSION_KEY_USERID, "100000");
    	param.put(DTO.SESSION_KEY_USERNAME,"Junit测试");
    	param.put(DTO.SESSION_KEY_SYSTEMID, "100000");
    	param.put(DTO.SESSION_KEY_CLIENTIP, "127.0.0.1");
    	param.put(DTO.SESSION_KEY_CLIENTTIME, DateUtils.getCurrDateTime());
